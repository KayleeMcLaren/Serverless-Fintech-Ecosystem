output "api_gateway_config_hash" {
  ...
  value = sha1(jsonencode([
    ...
    aws_api_gateway_method.delete_savings_goal_options_method,          # ADD
    aws_api_gateway_integration.delete_savings_goal_options_integration, # ADD
    aws_api_gateway_method_response.delete_savings_goal_options_200,   # ADD
