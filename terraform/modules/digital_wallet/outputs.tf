output "api_gateway_config_hash" {
  ...
  value = sha1(jsonencode([
    ...
    aws_api_gateway_method.create_wallet_options_method,
    aws_api_gateway_integration.create_wallet_options_integration,
    aws_api_gateway_method_response.create_wallet_options_200,
    aws_api_gateway_integration_response.create_wallet_options_integration_response,
